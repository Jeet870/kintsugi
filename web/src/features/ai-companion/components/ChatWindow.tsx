  ...
  return (
    <Sheet>
      ...
      >
        ...
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[600px] h-[350px] bg-gradient-to-tr from-amber-500/5 via-violet-600/5 to-transparent rounded-full blur-3xl pointer-events-none" />
